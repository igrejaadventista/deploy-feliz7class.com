...
if( !defined( 'PCIWGAS_VERSION' ) ) {
    define( 'PCIWGAS_VERSION', '1.4.6' ); // Version of plugin
}
...
if(!defined( 'PCIWGAS_PLUGIN_UPGRADE' ) ) {
    define('PCIWGAS_PLUGIN_UPGRADE','https://www.essentialplugin.com/wordpress-plugin/post-category-image-grid-slider/?utm_source=WP&utm_medium=Post-Category-Image&utm_campaign=Upgrade-PRO#wpos-epb'); // Plugin Check link
}
if(!defined( 'PCIWGAS_PLUGIN_WELCOME' ) ) {
    define('PCIWGAS_PLUGIN_WELCOME','https://www.essentialplugin.com/wordpress-plugin/post-category-image-grid-slider/?utm_source=WP&utm_medium=Post-Category-Image&utm_campaign=Welcome-Screen#wpos-epb'); // Plugin Check link
}
