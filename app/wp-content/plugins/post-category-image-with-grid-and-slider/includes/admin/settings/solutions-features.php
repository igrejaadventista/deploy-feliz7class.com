	...
	<div class="pciwgas-sf-wrap">
		<div class="pciwgas-sf-inr">
			...
			<div class="pciwgas-sf-welcome-wrap">
				<div class="pciwgas-sf-welcome-inr">
					<div class="pciwgas-sf-welcome-left">
						...
						<a href="<?php echo esc_url( $popup_add_link ); ?>" class="pciwgas-sf-btn">Launch Post Category Image</a></br> <b>OR</b> </br><a href="<?php echo PCIWGAS_PLUGIN_WELCOME; ?>"  target="_blank" class="pciwgas-sf-btn pciwgas-sf-btn-orange">Grab Now Pro Features</a>
				...
				<div class="pciwgas-features-section-inr">
					<div class="pciwgas-features-box-wrap">
						<ul class="pciwgas-features-box-grid">
							<li>
							<div class="pciwgas-popup-icon"><img src="<?php echo PCIWGAS_URL; ?>assets/images/popup-icon/post-grid.png" /></div>
							Post Category Grid View</li>
							<li>
							<div class="pciwgas-popup-icon"><img src="<?php echo PCIWGAS_URL; ?>assets/images/popup-icon/slider.png" /></div>
							Post Category Slider View</li>
							<li>
							<div class="pciwgas-popup-icon"><img src="<?php echo PCIWGAS_URL; ?>assets/images/popup-icon/centermode.png" /></div>
							Post Category Centermode View</li>
						</ul>
					</div>
					<a href="<?php echo PCIWGAS_PLUGIN_WELCOME; ?>" target="_blank" class="pciwgas-sf-btn pciwgas-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now Pro Features</a>
					<div class="pciwgas-rc-wrap">
						<div class="pciwgas-rc-inr pciwgas-rc-bg-box">
							<div class="pciwgas-rc-icon">
								<img src="<?php echo esc_url( PCIWGAS_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
			...
			<div class="pciwgas-sf-testimonial-wrap">
				<div class="pciwgas-center pciwgas-features-ttl">
					<h2 class="pciwgas-sf-ttl">Looking for a Reason to Use Post Category? Here are 3+...</h2>
				</div>
				<div class="pciwgas-testimonial-section-inr">
					<div class="pciwgas-testimonial-box-wrap">
						<div class="pciwgas-testimonial-box-grid">
							...
							<div class="pciwgas-testimonial-rating"><img src="<?php echo PCIWGAS_URL; ?>assets/images/rating.png" /></div>
						</div>
						<div class="pciwgas-testimonial-box-grid">
					...
					<a href="https://wordpress.org/support/plugin/post-category-image-with-grid-and-slider/reviews/?filter=5" target="_blank" class="pciwgas-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a> OR <a href="<?php echo PCIWGAS_PLUGIN_WELCOME; ?>"  target="_blank" class="pciwgas-sf-btn pciwgas-sf-btn-orange">Grab Now Pro Features</a>
					<div class="pciwgas-rc-wrap">
						<div class="pciwgas-rc-inr pciwgas-rc-bg-box">
							<div class="pciwgas-rc-icon">
								<img src="<?php echo esc_url( PCIWGAS_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
