...
<div class="wrap">
	...
	<h2><?php _e( 'Post Category Image', 'post-category-image-with-grid-and-slider' ); ?></h2><br />
	<style>
				...
				<table class="wpos-plugin-pricing-table">
				    ...
				    <thead>
				    	<tr>
				    		...
				    		<th>
				    			...
				    			<a href="<?php echo PCIWGAS_PLUGIN_UPGRADE; ?>" target="_blank">Buy Now</a>
				    		</th>	    		
				    	</tr>
				    </thead>
				    ...
				    <tfoot>
				    	<tr>
				    		...
				    		<td></td>
				    		<td>
							<a href="<?php echo PCIWGAS_PLUGIN_UPGRADE; ?>" class="wpos-button" target="_blank">Buy Now</a></td>
				    	</tr>
				    </tfoot>
					...
					<tbody>
						<tr>
							...
							<td>1 Designs for Post Grid, 1 Designs for Post Slider</td>
							<td>10 Designs for Post Grid, 10 Designs for Post Slider</td>
						</tr>
						<tr>
							<th>Shortcodes <span>Shortcode provide output to the front-end side</span></th>
							<td>2 – (Post Grid Shortcode, Post Slider Shortcode)</td>
							<td>2 – (Post Grid Shortcode, Post Slider Shortcode)</td>
						</tr>
						<tr>
						...
						<tr>
							<th>Image Height <span>You can set featured image height.</span></th>
							<td><i class="dashicons dashicons-no-alt"></i></td>
							<td><i class="dashicons dashicons-yes"></i></td>
						</tr>
						<tr>
